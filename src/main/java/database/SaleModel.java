...
public class SaleModel {
	...
	, bit_24,bit_25,bit_35,bit_37,bit_38, bit_39, bit_41, bit_42, bit_48,bit_55,bit_52,bit_60,bit_62, bit_63,bit_64,
	iso_request,iso_response,created_date,transaction_date;
	...
	public String getBit_35() {
		return bit_35;
	}
	public void setBit_35(String bit_35) {
		this.bit_35 = bit_35;
	}
	...
	public static SaleModel convertSaleModel(JSONObject object, String date) {
		...
		try {
			...
			for(int i=0; i < array.length(); i++) {
				...
				if ((Integer)obj.get("bit") == 35) model.setBit_35(obj.getString("value"));
